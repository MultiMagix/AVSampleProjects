...
public:
  ...
  unsigned sendAnnounceCommand(char const* sdpDescription, responseHandler* responseHandler, Authenticator* authenticator = NULL, const char* extraHeadersFromClient=NULL);
...
public: // Some compilers complain if this is "private:"
  ...
  public:
    RequestRecord(unsigned cseq, char const* commandName, responseHandler* handler,
		  ...
		  double start = 0.0f, double end = -1.0f, float scale = 1.0f, char const* contentStr = NULL, char const* clientHeaders = NULL);
	...
	char* GetExtraClientHeader() { return fExtraHeadersFromClient;}
	void SetResponseHeader(const char* strResponseHeaders) { fResponseHeaders = _strdup(strResponseHeaders);}
	char* GetResponseHeader() { return fResponseHeaders;}
  ...
  private:
	...
	char* fExtraHeadersFromClient;
	char* fResponseHeaders;
  };
private:
  class RequestQueue {
  public:
  ...
  unsigned sendRequest(RequestRecord* request, const char* extraHeadersFromClient = NULL);
